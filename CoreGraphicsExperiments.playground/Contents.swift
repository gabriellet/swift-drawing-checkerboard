...
class GradientView : UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        for i in stride(from: startX, to: rect.size.width, by: 2.0 * step) {
        ...
        for j in stride(from: startX, to: rect.size.height, by: 2.0 * step) {
        ...
        for i in stride(from: startX, to: rect.size.width, by: step) {
            ...
            for j in stride(from: startY, to: rect.size.height, by: step) {
